...
echo "${GREEN}${BOLD}Access the consent screen setup here:${RESET} https://console.cloud.google.com/apis/credentials/consent?project=$DEVSHELL_PROJECT_ID"
echo "${BLUE}${BOLD}Access the IAP setup here:${RESET} https://console.cloud.google.com/security/iap?tab=applications&project=$DEVSHELL_PROJECT_ID"

# Step 11: Create details.json with developer email
echo "${CYAN}${BOLD}Creating details.json file...${RESET}"
...
echo "${MAGENTA}${BOLD}Displaying details.json content...${RESET}"
...
case "${CHOICE^^}" in
    ...
    N)
        ...
        echo -e "${BOLD}${CYAN}https://www.youtube.com/@qwiklabexplorers${RESET}"
        ;;
    *)
